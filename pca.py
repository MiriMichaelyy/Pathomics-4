...
# FUNCTIONS                  #
##############################
def pcaPlot(pca, pca_df, hue, title,nColor=0, nShades=0, nColorTreat=0, nShadesTreat=0, nColorLay=0, nShadesLay=0, xlim_kmeans=[0,0], ylim_kmeans=[0,0]):
...
def pcaCalcOneExp(Groups, data, exp, title, FigureNumber, nColor=0, nShades=0):
